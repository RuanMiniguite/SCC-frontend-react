        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col items-center w-screen min-w-0">
            ...
            <div className="text-left text-2xl pt-16 w-[400px] xl:w-[600px] xl:text-3xl">
              <p className="pt-3 flex justify-evenly"><span className="w-[40%] text-left uppercase">Nome: </span>{funcionario.nome}</p>
              <p className="pt-3 flex justify-evenly"><span className="w-[40%] text-left uppercase">CPF: </span>{funcionario.cpf}</p>
              <p className="pt-3 flex justify-evenly"><span className="w-[40%] text-left uppercase">Telefone: </span>{funcionario.telefone}</p>
            </div>
